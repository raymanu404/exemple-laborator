...
namespace Domain
{
    ...
    {
        public static Task<IOrdersCart> ValidatedOrdersCartOP(Func<OrderRegistrationCode, TryAsync<bool>> checkOrderExist, UnvalidatedOrdersCart orders) =>
                orders.OrderList
        ...
        private static Func<UnvalidatedCustomerOrder, EitherAsync<string, ValidatedCustomerOrder>> ValidateCustomerOrder(Func<OrderRegistrationCode, TryAsync<bool>> checkOrdersExistsByRegsitrationCode) =>
                unvalidatedCustomerOrder => ValidateCustomerOrder(checkOrdersExistsByRegsitrationCode, unvalidatedCustomerOrder);

        private static EitherAsync<string, ValidatedCustomerOrder> ValidateCustomerOrder(Func<OrderRegistrationCode, TryAsync<bool>> checkOrderExists, UnvalidatedCustomerOrder unvalidatedCustomerOrder) =>
